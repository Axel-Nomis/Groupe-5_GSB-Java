	...
	public static Visiteur rechercher(String matricule) {
		...
		try {
			if (reqSelection.next()) {
				...
				unVisiteur = new Visiteur(reqSelection.getString(1), reqSelection.getString(2), reqSelection.getString(3), reqSelection.getString(4), reqSelection.getString(6), reqSelection.getString(7), reqSelection.getString(8),reqSelection.getString(9));	
			};
			}
		catch(Exception e) {
